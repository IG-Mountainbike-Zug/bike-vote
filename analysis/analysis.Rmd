...
result <- export_data_to_json(filtered_data, party_info, ordinal_map, new_names)
result
```
...
mds_data <- data %>% filter(canton == "Zug") %>%
  dplyr::select(-c(name, party, canton, mtb_statement))
