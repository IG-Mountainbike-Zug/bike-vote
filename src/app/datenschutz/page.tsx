  ...
  return (
    <>
      ...
      <p className="mb-4">
        ...
        Daten durch den Websitebetreiber IG Mountainbike Zug informieren.
      </p>
      ...
      <h2 className="mb-4 text-base font-bold">Reichweitenmessung & Cookies</h2>
      <p className="mb-4">
        ...
        Website. Falls Sie nicht möchten, dass Cookies zur Reichweitenmessung
      ...
      <ul className="mb-4">
        ...
        <li>
          ...
          <Link
            href="https://optout.aboutads.info/?c=2#!/"
            className="text-sky-600 hover:text-sky-900 hover:underline"
          >
      ...
      <p className="mb-4">
        ...
        Analytics innerhalb dieser Website Daten über Sie erfasst. Mit dem Klick
        auf obigen Link laden Sie ein „Opt-Out-Cookie“ herunter. Ihr Browser
        muss die Speicherung von Cookies also hierzu grundsätzlich erlauben.
        Löschen Sie Ihre Cookies regelmäßig, ist ein erneuter Klick auf den Link
