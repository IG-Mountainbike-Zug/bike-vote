  ...
  return (
    <>
      ...
      <div className="container mx-auto p-4">
        ...
        <p className="mb-4"></p>
        <ul>
          <li>IG Mountainbike Zug</li>
          <li>Eichstrasse 46</li>
          <li>6330 Cham</li>
          <li>E-Mail: info@mountainbikezug.ch</li>
        </ul>
        <h2 className="mb-4 text-base font-bold">
          Vertretungsberechtigte Personen
        </h2>
        <p className="mb-4">
          Vertretungsberechtigt sind die Mitglieder des Vorstands.
        </p>
        <h2 className="mb-4 text-base font-bold">Haftungsausschluss</h2>
        <p className="mb-4">
        ...
        <h2 className="mb-4 text-base font-bold">Haftung für Links</h2>
        <p className="mb-4">
        ...
        <h2 className="mb-4 text-base font-bold">Urheberrechte</h2>
        <p className="mb-4">
