    ...
    <>
      <div className="p-6">
        ...
        <p className="mb-4 text-lg">
          Herzlich willkommen auf unserer Plattform für politische Transparenz
          im Mountainbike-Sport! Hier kannst du dich über die Haltungen und
        ...
        <p className="mb-4 text-lg">
          ...
          einzubringen. Wir haben den Kandidatinnen und Kandidaten eine Reihe
          von Fragen zu Themen rund ums Mountainbiken gestellt. Ihre Antworten
          geben Aufschluss darüber, wie wichtig ihnen der Mountainbike-Sport und
          dessen Förderung ist.
        </p>
        <p className="mb-4 text-lg">
          ...
          Teilnehmenden verschaffen. Verschiedene Kennzahlen erleichtern dir
          zudem den Überblick.
        </p>
        <p className="mb-4 text-lg">
        ...
        <p className="text-lg">
          ...
          Mountainbikesport. Jetzt ist die Zeit, unsere Stimme zu erheben und
          das Mountainbiken in unserem Kanton weiter voranzutreiben!
        </p>
      </div>
    </>
  );
